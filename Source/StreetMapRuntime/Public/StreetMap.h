...
public:
	...
	UPROPERTY(Category = StreetMap, EditAnywhere, meta = (ClampMin = "0", UIMin = "0"), DisplayName = "Road Vertical Offset", BlueprintReadOnly)
		float RoadOffesetZ;

	/** if true buildings mesh will be 3D instead of flat representation. */
	UPROPERTY(Category = StreetMap, EditAnywhere, DisplayName = "Create 3D Buildings", BlueprintReadOnly)
	...
	*/
	UPROPERTY(Category = StreetMap, EditAnywhere, DisplayName = "Building Level Floor Factor", BlueprintReadOnly)
	...
	*/
	UPROPERTY(Category = StreetMap, EditAnywhere, DisplayName = "Lit buildings", BlueprintReadOnly)
		uint32 bWantLitBuildings : 1;

	/** Streets thickness */
	UPROPERTY(Category = StreetMap, EditAnywhere, meta = (ClampMin = "0", UIMin = "0"), BlueprintReadOnly)
